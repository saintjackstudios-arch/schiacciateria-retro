...
- **Google Analytics (GA4) / Google Tag:** ✅ collegato il 2026-07-29 (proprietà creata, tag installato nel codice — **da deployare in produzione**).
...
| Google Analytics 4 | ✅ collegato | proprietà "Schiacciateria Retrò Trieste" (ID `544...`, sotto account SaintJack Studios), Measurement ID `G-1GTNREENL7`. Tag installato in [src/components/Analytics.tsx](../src/components/Analytics.tsx), attivo solo dopo consenso cookie. **Non ancora in produzione** — serve deploy. |
